# Consult shift 2026-06-30T17:12:05Z
...
RECENT SCAR CLASSES: home_glob, home_glob, home_glob
...
VERDICT: System is live but executor is down, queue empty, brain healthy.  
Biggest risk: executor_live=false means no shell missions can run — any mission we issue will stall.

DO_NOT:
- Do not issue any shell missions while executor is down — they will queue and never execute.
- Do not attempt FAL spend, production wire, or taste pairs.
- Do not use home_glob or set fix_allowed=true.
