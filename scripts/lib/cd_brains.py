...
EXEMPLARS = {
  ...
  • مشهد الواقع: نفس المجموعة على نفس الطاولة، يضحكون بصوت عالٍ، وحدة تصيح: "خلوني أحكي لكم وش صار!"
  الطريقة: اللحظة اللي ينزل فيها التكلّف (مش الملابس). المنتج يعطي الإذن تكون عفوي.
  ⛔ خط أحمر صارم: مشهد "الواقع" لازم يبقى في مكان عام لائق (مجلس، طاولة، تجمع عائلي).
  ممنوع منعاً باتاً: السرير، غرفة النوم، خلع/إزالة أي ملابس أو حجاب، استغلال ضعف الناس. اكتب قصير ومترابط.""",
